 const htmlInput = document.getElementById("html-input");
        ...
        function checkAnswer() {
            ...
            if (generatedInput && (cleanInput.includes('type="password"') || cleanInput.includes("type='password'"))) {
                isCorrect = true;
                // ถ้าตอบถูก ให้เซ็ต value เป็นรหัสปลอมๆ ให้เห็นว่าจุดดำมันขึ้นจริง
                generatedInput.value = "secret123";
            }
        ...
        function showAnswer() {
            const answer = '<input type="password">';
            let i = 0;
